...
class CAHPAX2015CardProvider implements CardProvider
{
    const WHITE_CARDS = [
...
["text" => "\"It\'s not delivery.<br/>It\'s _.\"", "pick" => 1],
["text" => "Don\'t miss Rachel Ray\'s hit new show, Cooking with _.", "pick" => 1],
["text" => "Now on Netflix: Jiro Dreams of _.", "pick" => 1]
    ];
