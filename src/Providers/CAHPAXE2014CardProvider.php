...
class CAHPAXE2014CardProvider implements CardProvider
{
    const WHITE_CARDS = [
    ...
    const BLACK_CARDS = [
        ["text" => "Mistakenly hitting on a <i>League of Legends</i> statue."],
        ...
        ["text" => "Xena,<br>Warrior Princess."],
        ["text" => "Endless ninjas."],
        ["text" => "Whatever <i>Final Fantasy</i> bullshit happened this year."],
