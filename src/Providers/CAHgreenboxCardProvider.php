...
class CAHgreenboxCardProvider implements CardProvider
{
    const WHITE_CARDS = [
...
["text" => "As Teddy Roosevelt said, the four manly virtues are honor, temperance, industry, and _.", "pick" => 1],
["text" => "Best you go back where you came from, now. We don\'t take too kindly to _ in these parts.", "pick" => 1],
["text" => "CNN breaking news! Scientists discover _.", "pick" => 1],
["text" => "Coming to Red Lobster&reg; this month, _.", "pick" => 1],
["text" => "Congratulations! You have been selected for our summer internship program. While we are unable to offer a salary, we can offer you _.", "pick" => 1],
["text" => "Dance like there\'s nobody watching, love like you\'ll never be hurt, and live like you\'re _.", "pick" => 1],
...
["text" => "I\'ve had a horrible vision, father. I saw mountains crumbling, stars falling from the sky. I saw _.", "pick" => 1],
...
["text" => "Son, take it from someone who\'s been around the block a few times. Nothin\' puts her in the mood like _.", "pick" => 1],
["text" => "Summer lovin\', had me a blast. _, happened so fast.", "pick" => 1],
["text" => "\"The top Google auto-complete results for \"Barack Obama\":</br>- Barack Obama Height.</br>- Barack Obama net worth.</br>- Barack Obama _.\"", "pick" => 1],
