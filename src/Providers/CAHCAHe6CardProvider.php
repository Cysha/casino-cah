...
["text" => "This is America. If you don\'t work hard, you don\'t succeed. I don\'t care if you\'re black, white, purple, or _.", "pick" => 1],
["text" => "You Won\'t Believe These 15 Hilarious _ Bloopers!", "pick" => 1],
["text" => "James is a lonely boy. But when he discovers a secret door in his attic, he meets a magical new friend: _.", "pick" => 1],
["text" => "Don\'t worry kid. It gets better. I\'ve been living with _ for 20 years.", "pick" => 1],
["text" => "My grandfather worked his way up from nothing. When he came to this country, all he had was the shoes on his feet and _.", "pick" => 1],
["text" => "Behind every powerful man is _.", "pick" => 1],
["text" => "You are not alone. Millions of Americans struggle with _ every day.", "pick" => 1],
["text" => "Come to Dubai, where you can relax in our world famous spas, experience the nightlife, or simply enjoy _ by the poolside.", "pick" => 1],
["text" => "\"This is madness.\" \"No, THIS IS _!\"", "pick" => 1],
["text" => "Listen Gary, I like you. But if you want that corner office, you\'re going to have to show me _.", "pick" => 1],
...
["text" => "The six things I could never do without: oxygen, Facebook, chocolate, Netflix, friends, and _ LOL!", "pick" => 1],
["text" => "Why won\'t you make love to me anymore? Is it _?", "pick" => 1],
["text" => "Puberty is a time of change. You might notice hair growing in new places. You might develop an interest in _. This is normal.", "pick" => 1],
["text" => "I\'m sorry, Mrs. Chen, but there was nothing we could do. At 4:15 this morning, your son succumbed to _.", "pick" => 1],
["text" => "I\'m Miss Tennessee, and if I could make the world better by changing one thing, I would get rid of _.", "pick" => 1],
["text" => "Tonight we will have sex. And afterwards, If you\'d like, a little bit of _.", "pick" => 1],
["text" => "Everybody join hands and close your eyes. Do you sense that? That\'s the presence of _ in this room.", "pick" => 1],
["text" => "To become a true Yanomamo warrior, you must prove that you can withstand _ without crying out.", "pick" => 1],
["text" => "Y\'all ready to get this thing started? I\'m Nick Cannon, and this is America\'s Got _.", "pick" => 1],
["text" => "If you had to describe the Card Czar, using only one of the cards in your hand, which one would it be?", "pick" => 1]
    ];
